...
provider "kubernetes" {
  ...
  client_certificate     = base64decode(azurerm_kubernetes_cluster.kubefirst.kube_admin_config.0.client_certificate)
  client_key             = base64decode(azurerm_kubernetes_cluster.kubefirst.kube_admin_config.0.client_key)
  cluster_ca_certificate = base64decode(azurerm_kubernetes_cluster.kubefirst.kube_admin_config.0.cluster_ca_certificate)
}
