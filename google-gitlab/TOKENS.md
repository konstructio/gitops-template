...
This document lists all template tokens used in this Google Cloud + GitLab cloud provider configuration. These tokens are replaced during the GitOps template instantiation process.
