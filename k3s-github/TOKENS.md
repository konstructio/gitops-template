...
This document lists all template tokens used in this K3S + GitHub bare-metal configuration. These tokens are replaced during the GitOps template instantiation process.
